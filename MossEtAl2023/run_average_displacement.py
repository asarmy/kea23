"""This file runs the MEA22 model to calculate the average displacement as a function of magnitude.
...
from MossEtAl2023.functions import _calc_distrib_params_mag_ad
...
def run_ad(
    *,
    ...
    """
    Run MEA22 model to calculate the average displacement as a function of magnitude. All parameters
...
def main():
    description_text = """Run MEA22 model to calculate the average displacement as a function of
