"""This file runs the MEA22 model to calculate the max displacement as a function of magnitude.
...
def run_md(
    *,
    ...
    """
    Run MEA22 model to calculate the maximum displacement as a function of magnitude. All parameters
...
def main():
    description_text = """Run MEA22 model to calculate the maximum displacement as a function of
